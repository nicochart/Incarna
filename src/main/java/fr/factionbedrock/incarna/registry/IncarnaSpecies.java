...
public class IncarnaSpecies
{
    ...
    public static IncarnaSpecie ELF = new  IncarnaSpecie(1, "elf", IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER, IncarnaPowers.VEGAN, IncarnaPowers.SPEED_ABILITY, IncarnaPowers.DAMAGE_IN_NETHER).hasAbility(true);
