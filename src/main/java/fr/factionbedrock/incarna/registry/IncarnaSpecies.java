...
public class IncarnaSpecies
{
    ...
    public static IncarnaSpecie AERIAN = new  IncarnaSpecie(11, "aerian", IncarnaPowers.CONSTANT_SLOW_FALLING_EFFECT, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER);
