...
public class IncarnaSpecies
{
    ...
    public static IncarnaSpecie ELF = new  IncarnaSpecie(1, "elf", IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.CONSTANT_SPEED_EFFECT, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER, IncarnaPowers.VEGAN, IncarnaPowers.SPEED_ABILITY, IncarnaPowers.DAMAGE_IN_NETHER).hasAbility(true);
    ...
    public static IncarnaSpecie ENDERIAN = new  IncarnaSpecie(8, "enderian", IncarnaPowers.CONSTANT_NIGHT_VISION_EFFECT, IncarnaPowers.CONSTANT_SCALE_MODIFIER, IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.DAMAGE_IN_WATER, IncarnaPowers.TELEPORT_ON_PROJECTILE_DAMAGE, IncarnaPowers.CANCEL_LOW_FALL_DAMAGE, IncarnaPowers.THROW_ENDERPEARL_ABILITY).hasAbility(true);
    ...
    public static IncarnaSpecie LUNAR_ELF = new  IncarnaSpecie(12, "lunar_elf", IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER, IncarnaPowers.VEGAN, IncarnaPowers.INCREASED_FALL_DAMAGE, IncarnaPowers.DAMAGE_IN_NETHER);
