...
public class IncarnaSpecies
{
    ...
    public static IncarnaSpecie ELF = new  IncarnaSpecie(1, "elf", IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.CONSTANT_SPEED_EFFECT, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER, IncarnaPowers.VEGAN, IncarnaPowers.SPEED_ABILITY);
    ...
    public static IncarnaSpecie FALLEN_ANGEL = new  IncarnaSpecie(4, "fallen_angel", IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.FIRE_RESISTANCE_ABILITY);
    ...
    public static IncarnaSpecie AERIAN = new  IncarnaSpecie(11, "aerian", IncarnaPowers.SLOW_FALLING_ABILITY, IncarnaPowers.CONSTANT_JUMP_STRENGTH_MODIFIER);
