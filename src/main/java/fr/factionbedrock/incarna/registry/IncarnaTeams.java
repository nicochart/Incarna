...
public class IncarnaTeams
{
    ...
    public static  IncarnaTeam END = new  IncarnaTeam(3, "end", IncarnaPowers.CONSTANT_NIGHT_VISION_EFFECT, IncarnaPowers.CONSTANT_SPEED_MODIFIER, IncarnaPowers.INCREASED_FALL_DAMAGE, IncarnaPowers.DAMAGE_IN_WATER);
