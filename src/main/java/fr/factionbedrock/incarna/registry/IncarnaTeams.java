...
public class IncarnaTeams
{
    ...
    public static  IncarnaTeam NETHER = new  IncarnaTeam(2, "nether", IncarnaPowers.CONSTANT_FIRE_RESISTANCE_EFFECT, IncarnaPowers.CARNIVORE, IncarnaPowers.PREVENT_BOW_USE);
